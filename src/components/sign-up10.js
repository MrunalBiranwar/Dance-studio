          ...
          <div className="sign-up10-form1 thq-section-padding">
            <div className="sign-up10-title-root">
              <h2 className="sign-up10-text1 thq-heading-2">
                {props.heading1 ?? (
                  <Fragment>
                    <span className="sign-up10-text9">
            ...
            <button
              type="submit"
              className="sign-up10-button1 thq-button-filled"
            >
              <span className="sign-up10-text6 thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="sign-up10-text8">Sign Up Now</span>
                  </Fragment>
                )}
              </span>
            </button>
...
SignUp10.defaultProps = {
  ...
  heading1: undefined,
  image1Src:
    "https://images.unsplash.com/photo-1519408469771-2586093c3f14?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTUwNjM3OXw&ixlib=rb-4.0.3&q=80&w=1080",
