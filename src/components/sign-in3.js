        ...
        <div className="sign-in3-form-root">
          <div className="sign-in3-form1">
            <h2 className="sign-in3-text10 thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="sign-in3-text18">Welcome back!</span>
                </Fragment>
              )}
            </h2>
...
SignIn3.defaultProps = {
  ...
  image1Src:
    'https://images.unsplash.com/photo-1542850347-cdeedb4f509f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMTUwNjI3OHw&ixlib=rb-4.0.3&q=80&w=1080',
  action1: undefined,
  heading1: undefined,
  content1: undefined,
  action2: undefined,
